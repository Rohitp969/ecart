...
//        <div className='grid grid-cols-2 items-start gap-20 mt-20 max-w-7xl mx-auto'>
...
//                           return <div key={index} className={`border p-4 rounded-md cursor-pointer relative 
//                             ${selectedAddress === index ? "border-pink-600 bg-pink-50":"border-gray-300"}`}>
//                               <p className='font-medium'>{addr.fullName}</p>
//                               <p>{addr.phone}</p>
//                               <p>{addr.email}</p>
//                               <p>{addr.address}, {addr.state}, {addr.zip}, {addr.country}</p>
...
//                       <Button disabled={selectedAddress === null} onClick={handlePayment} className="w-full bg-pink-600">Process To Checkout</Button>
//                     </div>
//                 )
//             }
//         </div>
