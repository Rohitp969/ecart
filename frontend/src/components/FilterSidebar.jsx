...
const FilterSidebar = ({allProducts, search, setSearch, category, setCategory, brand, setBrand, priceRange, setPriceRange}) => {
    ...
    <div className='bg-gray-100 mt-10 p-4 rounded-md h-max hidden md:block w-64'>
      ...
      <h1 className='mt-5 font-semibold text-xl'>Brand</h1>
       <select className='bg-white w-full p-2 border-gray-200 border-2 rounded-md'
        ...
        {
      UniqueBrand?.filter(Boolean).map((item, index) => (
